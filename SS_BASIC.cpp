...
class DataMem    
{
    public: 
        ...
        void writeDataMem(bitset<32> Address, bitset<32> WriteData) {
            ...
            DMem[Address.to_ulong()]=bitset<8>(data.substr(24,8));
             DMem[Address.to_ulong()+1]=bitset<8>(data.substr(16,8));
              DMem[Address.to_ulong()+2]=bitset<8>(data.substr(8,8));
               DMem[Address.to_ulong()+3]=bitset<8>(data.substr(0,8));
        }   
